...
from .collator import collator, collator_with_resistance_distance
...
class BatchedDataDataset(FairseqDataset):
    def __init__(
        self, dataset, max_node=128, multi_hop_max_dist=5, spatial_pos_max=1024, with_resistance_distance=False
    ):
        super().__init__()
    ...
    def collater(self, samples):
        ...
        ) if not self.with_resistance_distance else collator_with_resistance_distance
